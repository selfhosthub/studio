# workers/studio_workers/worker.py
# !/usr/bin/env python3
"""
...
Examples:
    WORKER_TYPE=general python -m studio_workers.worker      # HTTP calls, webhooks
    WORKER_TYPE=video python -m studio_workers.worker        # GPU video processing
    WORKER_TYPE=comfyui-image python -m studio_workers.worker  # GPU ComfyUI image gen
"""
import logging
import os
import sys
...
from studio_workers.utils.logging_config import setup_logging
...
HANDLER_REGISTRY = {
    "general": ("studio_workers.engines.general.handler", "WorkflowOrchestrator"),
    "video": ("studio_workers.engines.video.handler", "VideoWorker"),
    "audio": ("studio_workers.engines.audio.handler", "AudioWorker"),
    "comfyui-image": ("studio_workers.engines.comfyui.handler", "ComfyUIWorker"),
    "comfyui-image-edit": ("studio_workers.engines.comfyui.handler", "ComfyUIWorker"),
    "comfyui-video": ("studio_workers.engines.comfyui.handler", "ComfyUIWorker"),
    "transfer": ("studio_workers.engines.transfer.handler", "TransferWorker"),
}
