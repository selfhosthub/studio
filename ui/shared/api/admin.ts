...
// A namespaced package id (`namespace/slug`, e.g. `shs/core`) is already the
// two-segment path the backend routes expect (`/{namespace}/{slug}`), matching
// the workflows/prompts marketplaces. Catalog ids are constrained to
