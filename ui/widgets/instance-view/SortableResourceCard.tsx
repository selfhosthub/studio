    ...
    <div ref={setNodeRef} style={style} className="relative group outline-none">
      ...
      {isDragEnabled && (
        <div
          {...attributes}
          {...listeners}
          className="absolute top-2 right-2 z-10 p-1.5 bg-black/60 hover:bg-black/80 rounded cursor-grab active:cursor-grabbing opacity-0 group-hover:opacity-100 focus-visible:opacity-100 focus-visible:ring-2 focus-visible:ring-primary transition-opacity"
