        ...
        {editMode ? (
          <div className="mt-6 border border-primary rounded-md p-4 space-y-4">
            ...
            <div className="flex space-x-2">
              <button
                ...
                className="px-4 py-2 bg-info text-white rounded-md hover:opacity-90 focus:outline-none focus-visible:ring-2 focus-visible:ring-primary disabled:opacity-50 disabled:cursor-not-allowed"
              >
                Add Field
              </button>
              <button
          ...
          <div className="mt-4">
            <button
              ...
              className="px-4 py-2 bg-info text-white rounded-md hover:opacity-90 focus:outline-none focus-visible:ring-2 focus-visible:ring-primary"
            >
              Add Output Field
            </button>
          </div>
