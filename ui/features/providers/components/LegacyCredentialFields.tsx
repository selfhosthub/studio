// ui/features/providers/components/LegacyCredentialFields.tsx

import type { CredentialFormValues } from '../credential-types';
import { OAuthCredentialFields, type OAuthFieldValues } from './OAuthCredentialFields';
  ...
  return (
    <>
      ...
      <div>
        ...
        {!useJsonMode ? (
          credentialForm.credential_type === 'oauth' ? (
...
function JsonModeField({
  ...
  const placeholder = placeholders[credentialForm.credential_type] || '{"key": "value"}'; // defaults-ok
