...
export function ProviderDocsSlideOver({ slug, isOpen, onClose, alternateProviders, fetchContent }: ProviderDocsSlideOverProps) {
  ...
  // Sync activeSlug when parent slug changes (Pattern B: adjust during render, not in an effect)
  ...
  // Gate SSR: set isMounted once on client (Pattern D: ref-flag + direct top-level set)
