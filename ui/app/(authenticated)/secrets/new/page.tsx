// ui/app/(authenticated)/secrets/new/page.tsx
...
export default function NewSecretPage() {
  return (
    <Suspense>
      <NewSecretPageContent />
    </Suspense>
  );
}

function NewSecretPageContent() {
  ...
  // Creating org secrets is admin-only; bounce non-admins (the backend also 403s).
