// ui/app/(authenticated)/providers/list/page.tsx
    ...
    <>
      <div className="px-4 sm:px-6 lg:px-8 py-8 w-full max-w-9xl mx-auto">
        <div className="flex flex-wrap justify-between items-center gap-4 mb-8">
          ...
          {user?.role === 'super_admin' && (activeTab === 'organization' || activeTab === 'custom' || activeTab === 'marketplace') && (
        ...
        {(activeTab === 'organization' || activeTab === 'custom') && (
          <ProvidersList customOriginOnly={isSuperAdmin} />
        )}
