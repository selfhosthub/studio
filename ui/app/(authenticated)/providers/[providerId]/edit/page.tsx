// ui/app/(authenticated)/providers/[providerId]/edit/page.tsx
...
export default function EditProviderPage({
  ...
  return (
    <Suspense>
      <EditProviderPageContent providerId={providerId} />
    </Suspense>
  );
}

function EditProviderPageContent({ providerId }: { providerId: string }) {
  const router = useRouter();
  const { returnTo } = useReturnTo(`/providers/${providerId}`);
  const { user } = useUser();
