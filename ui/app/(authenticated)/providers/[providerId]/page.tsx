// ui/app/(authenticated)/providers/[providerId]/page.tsx
...
import { useReturnTo, withReturnTo } from '@/shared/hooks/useReturnTo';

export default function ProviderDetailsPage() {
  return (
    <Suspense>
      <ProviderDetailsPageContent />
    </Suspense>
  );
}

function ProviderDetailsPageContent() {
      ...
      <>
        <div className="px-4 sm:px-6 lg:px-8 py-8 w-full max-w-9xl mx-auto">
          <div className="alert alert-error">
            ...
            <Link href={returnTo} className="mt-2 text-info hover:underline">
      ...
      <div className="px-4 sm:px-6 lg:px-8 py-8 w-full max-w-9xl mx-auto">
        ...
        <div className="mb-8">
          <div className="flex items-center mb-2">
            <Link href={returnTo} className="text-info hover:underline mr-2">
              Providers
            </Link>
        ...
        <div className="flex space-x-4">
          {user?.role === 'super_admin' && (
            <>
              <Link
                href={withReturnTo(`/providers/${providerId}/edit`, returnTo)}
        ...
        {provider && getProviderDocSlug(provider) && (
          <ProviderDocsSlideOver
            slug={getProviderDocSlug(provider)!}
            isOpen={isDocsOpen}
