// ui/app/(authenticated)/workflows/upload/page.tsx

"use client";

import React, { useState, useRef } from 'react';
import { useRouter } from 'next/navigation';
import { importWorkflow } from '@/shared/api';
    ...
    <div className="px-4 sm:px-6 lg:px-8 py-8 w-full max-w-3xl mx-auto">
        <div className="mb-8">
          ...
          <p className="text-sm mt-1 text-secondary">
            Install a workflow from a single JSON file
          </p>
        </div>
          ...
          <div className="mt-6 bg-surface rounded-lg p-4">
            ...
            <ul className="text-xs text-secondary space-y-1">
              <li className="flex items-center gap-2">
                ...
                <code className="bg-card px-1 rounded">name</code>, <code className="bg-card px-1 rounded">steps</code>
              </li>
            </ul>
          </div>
