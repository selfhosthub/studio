// ui/app/(authenticated)/workflows/components/OutputSchemaDisplay.tsx
...
function renderSchemaField(
  ...
  if (fieldType === 'object' && schema.properties) { // form-field-switch-ok - JSON-schema output type, not a form-field render
  ...
  if (fieldType === 'array' && schema.items?.properties) { // form-field-switch-ok - JSON-schema output type, not a form-field render
