// ui/app/(authenticated)/workflows/[id]/edit/components/FlowEditorSection.tsx
...
interface FlowEditorSectionProps {
  ...
  steps: {
    ...
    addStep: () => void;
    addConnectedStep: (sourceStepId: string, position: { x: number; y: number }) => void;
  };
  connections: {
...
export function FlowEditorSection({
  ...
  const sharedEditorProps = {
    ...
    onCreateConnectedStep: steps.addConnectedStep,
