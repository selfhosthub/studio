// ui/app/providers/[providerId]/credentials/components/WebhookCallbackFields.tsx
 ...
 * user must then update the provider with the new value). Values are generated
 * client-side and persist only when the credential is saved. The URL host is the
 * public API base (getApiEndpoint), correct behind a tunnel/proxy.
 */
