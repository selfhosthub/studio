...
def setup_rich_logging(
    ...
    custom_theme = Theme(  # type: ignore[possibly-unbound]  - guarded by RICH_AVAILABLE early-return above
        {
            "info": "green",
            "warning": "yellow",
            "error": "bold red",
    ...
    console = Console(  # type: ignore[possibly-unbound]  - guarded by RICH_AVAILABLE early-return above
        force_terminal=True,
        theme=custom_theme,
    ...
    handler = RichHandler(  # type: ignore[possibly-unbound]  - guarded by RICH_AVAILABLE early-return above
        console=console,
        show_time=True,
        show_level=True,
        show_path=False,
    ...
    if enable_access_logs:
        ...
        access_logger.addFilter(LogInjectionFilter())
    else:
