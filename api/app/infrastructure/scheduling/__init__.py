...
Not a workflow scheduler. Workflow scheduling (RRULE schedules, per-workflow
schedules, catch-up semantics, timezone handling) is a separate feature that
*consumes* this primitive; see `schedule_task.py` in this package.
"""
