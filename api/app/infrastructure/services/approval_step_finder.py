...
class ApprovalStepFinder:
    ...
    async def _check_service_hints(
        ...
        # Approval is declared in the catalog via orchestrator_hints.wait_for. A
        # service the DB doesn't know is not silently treated as an approval step
        # - no hardcoded service-id fallback.
        return False
