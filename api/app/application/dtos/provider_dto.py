...
class ProviderServiceResponse(BaseModel):
    ...
    # Lifted from client_metadata so the UI can read them without name-matching.
    ...
    def from_domain(cls, service: ProviderService) -> "ProviderServiceResponse":
        return cls(
            ...
            requires_credentials=service.client_metadata.get(
                "requires_credentials", True
            ),
            dispatch=service.client_metadata.get("dispatch"),
