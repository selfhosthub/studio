...
class OrgFileService:
    ...
    async def select_resource(self, resource_id: uuid.UUID) -> OrgFile:
        return await self._resource_service.select_resource(resource_id)
    ...
    async def upload_file_to_step(
        ...
        return await self._upload_service.upload_file_to_step(
            ...
            caller_thumbnail_content=caller_thumbnail_content,
        )
    ...
    async def register_step_file_in_place(
        ...
        return await self._upload_service.register_step_file_in_place(
            instance_id=instance_id,
            step_key=step_key,
            organization_id=organization_id,
            ...
            job_execution_id=job_execution_id,
            instance_step_id=instance_step_id,
            has_caller_thumbnail=has_caller_thumbnail,
        )
