...
class Organization(AggregateRoot):
    ...
    # Staging organization: receives staging-visibility catalog packages. super_admin-set.
    ...
    def set_staging(self, value: bool) -> bool:
        """Set the staging-tenant flag (super_admin-controlled). Returns the
