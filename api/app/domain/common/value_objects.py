...
class ResourceSpecification(BaseModel):
    ...
    max_retry_count: Optional[int] = Field(default_factory=lambda: get_settings().DEFAULT_MAX_RETRIES)
...
class JobConfig(BaseModel):
    ...
    timeout_seconds: Optional[int] = None
    retry_count: Optional[int] = Field(default_factory=lambda: get_settings().STEP_DEFAULT_RETRY_COUNT)
    retry_delay_seconds: Optional[int] = Field(default_factory=lambda: get_settings().DEFAULT_RETRY_DELAY_SECONDS)
